<div class="p-4 sm:ml-64">
    ...
    <h3
        ...
        Pemberian Nilai Bobot pada Matriks Optimasi</h3>
            ...
            <tbody>
                <?php foreach ($location as $row): ?>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">
                            <?= $resultCriteriaOne * $Weight[0]; ?>
                        </td>
                        <td class="px-6 py-4">
                            <?= $resultCriteriaTwo * $Weight[1]; ?>
                        </td>
                        <td class="px-6 py-4">
                            <?= $resultCriteriaThree * $Weight[2]; ?>
                        </td>
                        <td class="px-6 py-4">
                            <?= $resultCriteriaFour * $Weight[3]; ?>
                        </td>
                        <td class="px-6 py-4">
                            <?= $resultCriteriaFive * $Weight[4]; ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
